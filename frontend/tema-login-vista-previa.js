(() => {
  ...
  style.textContent = `
    ...
    .light-orbit--echo { height: min(42vw, 520px); left: min(-17vw, -140px); bottom: min(-25vw, -175px); opacity: .62; width: min(42vw, 520px); animation: lightOrbitPulse 5.5s ease-in-out infinite reverse; }
    .light-spotlight {
